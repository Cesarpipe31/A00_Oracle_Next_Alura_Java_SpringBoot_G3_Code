...
import Api.rest.para.Voll.clinica.domain.medico.*;
...
public class MedicoController {
    ...
    public ResponseEntity<DatosRespuestaMedico> registrarMedico(@RequestBody @Valid DatosRegistroMedico datosRegistroMedico,
        ...
        // Return 201 Created
        // URL donde encontrar al médico (buena practica, siempre)
        // GET http://localhost:8080/medicos/ss
    ...
    @GetMapping("/{id}")
    public ResponseEntity<DatosRespuestaMedico> retorDatosMedico(@PathVariable  Long id){
        Medico medico = medicoRepository.getReferenceById(id);
